package com.intermediateandroid.mymediaplayer
...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.intermediateandroid.mymediaplayer.mediaservice.create"
        const val ACTION_DESTROY = "com.intermediateandroid.mymediaplayer.mediaservice.destroy"
